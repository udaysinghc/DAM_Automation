...
public class addnewworkflowPage {
	...
	@FindBy(how=How.XPATH, using = "//*[text()='Workflows']")
	WebElement WorkflowsMenuLink;
	
	@FindBy(how=How.XPATH, using = "//a[contains(text(),'Create Workflow')]")
	...
	public void clickAdminMenuLink() throws InterruptedException
	{
		AdminMenuLink.click();
		Thread.sleep(1000);
	}
	
	public void clickWorkflowLink() throws InterruptedException
	{
		WorkflowsMenuLink.click();
		Thread.sleep(1000);
	}
